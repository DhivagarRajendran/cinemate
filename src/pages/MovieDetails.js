    ...
    <main className="flex items-center justify-center">
      <section className="flex justify-around flex-wrap py-5 gap-5">
        ...
        <div className="max-w-2xl text-gray-700 text-lg dark:text-white">
          <p className="text-4xl font-bold text-center lg:text-left my-3">{movie.title}</p>
          ...
          <div className="flex items-center">
            ...
            <span className="w-2 h-2 bg-gray-400 dark:gray-100 rounded-full mx-2 mt-1"></span>
